...
fn get_latest_token_event(nft_contract_hash: ContractHash) {
    ...
    let (receipt_name, latest_token_event): (String, String) = runtime::call_contract(nft_contract_hash, ENTRY_POINT_GET_LATEST_TOKEN_EVENT, token_identifier_runtime_args);
